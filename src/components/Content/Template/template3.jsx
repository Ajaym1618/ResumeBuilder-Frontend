...
const Template3 = ({userInfo,formatMonthYear}) => {
  return (
    <div className="w-[816.5px] h-[100%] overflow-y-scroll overflow-x-none bg-white flex gap-10 ">
          <div className="h-[100%] w-[60%] pl-2">
            <div className="w-[90%] m-auto pt-14">
              <h1 className="text-[30px] font-semibold text-[#2c5977]">
              ...
              <h2 className="text-[22px] text-[#2c5977]">
                {userInfo?.personalInfo?.jobTitle
                  ? userInfo?.personalInfo.jobTitle
                  : "Human Resource Manager"}
              </h2>
            </div>
            <div className="w-[90%] m-auto pt-5  text-[14px] break-words">
              <h1 className="text-[22px] border-b-2 font-semibold border-[#2c5977] mb-3 text-[#2c5977]">
                Objective
              </h1>
            ...
            <div className="w-[90%] m-auto pt-5 font-semibold">
              <h1 className="text-[22px] border-b-2 border-[#2c5977] mb-3 text-[#2c5977]">
                Experience
              </h1>
            ...
            <div className="w-[90%] m-auto pt-2 font-semibold">
              <h1 className="text-[22px] border-b-2 border-[#2c5977] mb-3 text-[#2c5977]">
                Education
              </h1>
            ...
            <div className="w-[90%] m-auto pt-3 mb-3 break-words">
              <h1 className="text-[22px] border-b-2 border-[#2c5977] font-semibold mb-3 text-[#2c5977]">
                Projects
              </h1>
          ...
          {/* second container */}
          <div className="h-[1056.5px] w-[40%] bg-[#2c5977] text-white">
            <div className="w-[90%] m-auto pt-14">
