...
const Template2 = ({ userInfo, formatMonthYear }) => {
  return (
    <div className="w-[816.5px] h-[100%] overflow-y-scroll overflow-x-none bg-white px-8 ">
      {/* header */}
      <div className="w-[100%] pt-14 flex justify-between">
        <div>
          <h1 className="text-[30px] font-semibold text-[#1b6b5f]">
          ...
          <h2 className="text-[22px] text-[#1b6b5f]">
      ...
      {/* Objective */}
      <div className="w-[100%] pt-5  text-[14px] break-words">
        <h1 className="text-[22px] border-b-2 font-semibold border-[#1b6b5f] mb-3 text-[#1b6b5f]">
          Objective
        </h1>
      ...
      <div className="w-[100%] m-auto pt-5 font-semibold">
        <h1 className="text-[22px] border-b-2 border-[#1b6b5f] mb-3 text-[#1b6b5f]">Experience</h1>
      ...
      <div className="flex gap-6">
        <div className="w-[80%] font-semibold">
          <h1 className="text-[22px] border-b-2 border-[#1b6b5f] mb-3 text-[#1b6b5f]">
            Education
          </h1>
      ...
      <div className="w-[100%] m-auto pt-3 mb-3 break-words">
        <h1 className="text-[22px] border-b-2 border-[#1b6b5f] font-semibold mb-3 text-[#1b6b5f]">
          Projects
        </h1>
      ...
      <div className="flex gap-6 mb-6">
        <div className="w-[90%] font-semibold ">
          <h1 className="text-[22px] border-b-2 border-[#1b6b5f] mb-3 text-[#1b6b5f]">Skills</h1>
        ...
        <div className="w-[90%] font-semibold ">
          <h1 className="text-[22px] border-b-2 border-[#1b6b5f] mb-3 text-[#1b6b5f]">Hobbies</h1>
          <ul className="list-disc list-inside pl-6 font-light text-[16px]">
