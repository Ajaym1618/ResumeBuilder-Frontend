...
const Template1 = ({userInfo,formatMonthYear}) => {
  return (
    <div className="w-[816.5px] h-[100%] overflow-y-scroll overflow-x-none bg-white flex gap-20 px-6 ">
          <div className="h-[100%] w-[49%]">
            ...
            <div className="w-[90%] m-auto pt-5  text-[14px] break-words">
              <h1 className="text-[22px] border-b-2 font-semibold border-black mb-3">
                Objective
              </h1>
            ...
            <div className="w-[90%] m-auto pt-5 font-semibold">
              <h1 className="text-[22px] border-b-2 border-black mb-3">
                Experience
              </h1>
            ...
            <div className="w-[90%] m-auto pt-3 mb-3 break-words">
              <h1 className="text-[22px] border-b-2 border-black font-semibold mb-3">
                Projects
              </h1>
