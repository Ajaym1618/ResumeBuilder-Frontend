...
const PreviewTemplate5 = () => {
  ...
  const getData = async () => {
    try {
      const res = await axios.get(
        `https://swiftresume-backend.onrender.com0/SignUpData/${user._id}`
      );
  ...
  return (
    <>
      <div className="h-[100vh] w-[100%] relative bg-[#000000bf] flex justify-center items-center text-white px-4 max-[426px]:h-auto max-[426px]:px-0">
        <div class="w-[600px] h-[100vh] flex text-black bg-white download max-[426px]:w-[100%]">
          <div className="h-auto w-[60%] max-[768px]:pt-3">
            <div className="w-[100%] pt-2 pl-5 bg-[#eae7ff]">
              <h1 className="text-[20px] font-bold text-[#5b509b] max-[768px]:text-[15px] max-[321px]:text-[14px]">
              ...
              <h2 className="text-[15px] text-[#5b509b] max-[768px]:text-[12px] max-[321px]:text-[11px]">
                {userInfo.personalInfo?.jobTitle
                  ? userInfo.personalInfo.jobTitle
                  : "Human Resource Manager"}
              </h2>
            </div>
            <div className="w-[100%]  pt-1 text-[10px] break-words max-[768px]:text-[8px] max-[321px]:text-[7px]">
              <h1 className="text-[15px] pl-5 font-bold mb-1 bg-[#eae7ff] text-[#5b509b] max-[768px]:text-[12px] max-[321px]:text-[11px]">
                Objective
              </h1>
              <p className="indent-4 pl-5">
            ...
            <div className="w-[100%] pt-1 font-bold">
              <h1 className="text-[15px] pl-5 bg-[#eae7ff] mb-1 text-[#5b509b] max-[768px]:text-[12px] max-[321px]:text-[11px]">
                Experience
              </h1>
              {userInfo.experience?.length > 0 ? (
                ...
                <div className="pl-5">
                  ...
                  <h3 className="text-[12px] font-semibold max-[768px]:text-[10px]">
                    Zoho, Chennai, Tamilnadu
                  </h3>
            ...
            <div className="w-[100%] mt-1">
              <h1 className="text-[15px] bg-[#eae7ff] pl-5 font-bold mb-1 text-[#5b509b] max-[768px]:text-[12px]">
                Education
              </h1>
            ...
            <div className="w-[100%] py-1 break-words max-[426px]:py-0">
              <h1 className="text-[15px] pl-5 bg-[#eae7ff] font-bold mb-1 text-[#5b509b]  max-[768px]:text-[12px]">
                Projects
              </h1>
          ...
          <div className="h-[100vh] w-[40%] bg-[#5b509b] text-white">
            ...
            <div className="w-[90%] m-auto pt-3 font-semibold ">
              <h1 className="text-[15px] border-b-2 border-white mb-3 max-[768px]:text-[12px]">
                Skills
              </h1>
            ...
            <div className="w-[90%] m-auto pt-3">
              <h1 className="text-[15px] border-b-2 font-semibold border-white mb-3 max-[768px]:text-[12px] max-[768px]:mb-1">
                Achievements
              </h1>
              {userInfo.achievements?.length > 0 ? (
                userInfo.achievements.map((achievement, index) => (
                  <div key={index}>
                    <h2 className="text-[12px]  max-[768px]:text-[10px]">
                      {achievement.courseName || "Course Name"}
                    </h2>
                    <h3 className="font-semibold text-[10px] mb-1  max-[768px]:text-[8px] max-[768px]:mb-0">
            ...
            <div className="w-[90%] m-auto pt-3 font-semibold ">
              <h1 className="text-[15px] border-b-2 border-white mb-3 max-[768px]:text-[12px] max-[768px]:mb-1">
                Hobbies
              </h1>
              <ul className="list-disc list-inside pl-6 font-light text-[12px] max-[768px]:text-[10px]">
      ...
      <button
        className="w-[100px] z-20 absolute top-[90%] right-[34%] text-white bg-[#135c4d] py-2 shadow-slate-500 shadow-lg text-[16px] rounded-md active:scale-95 duration-150  max-[426px]:text-[12px] max-[768px]:right-[23%] max-[426px]:right-[10%]"
        onClick={download}
      >
        Download
      </button>
...
export default PreviewTemplate5;
