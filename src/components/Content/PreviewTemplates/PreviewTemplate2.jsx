...
const PreviewTemplate2 = () => {
  ...
  return (
    <>
    <div className="h-[100vh] w-screen bg-[#000000bf] relative flex justify-center items-center text-white px-4 max-[426px]:h-auto max-[426px]:px-0">
      <div class="w-[600px] h-[100vh] text-black bg-white download max-[426px]:w-[100%]">
        {/* header */}
        <div className="w-[90%] pt-2 m-auto flex justify-between">
          <div>
            <h1 className="text-[20px] font-bold text-[#1b6b5f] max-[768px]:text-[15px]">
            ...
            <h2 className="text-[14px] text-[#1b6b5f] max-[768px]:text-[12px]">
        ...
        {/* Objective */}
        <div className="w-[90%] m-auto pt-1 text-[12px] break-words">
          <h1 className="text-[14px] border-b-2 font-semibold border-[#1b6b5f] mb-1 text-[#1b6b5f] max-[768px]:text-[12px]">
            Objective
          </h1>
          <p className="indent-2 text-[9px] max-[768px]:text-[8px]">
        ...
        {/* Experience */}
        <div className="w-[90%] m-auto pt-1 font-semibold">
          <h1 className="text-[14px] border-b-2 border-[#1b6b5f] mb-1 text-[#1b6b5f] max-[768px]:text-[12px]">
            Experience
          </h1>
          {userInfo?.experience?.length > 0 ? (
            userInfo?.experience.map((exp, index) => (
              <div key={index}>
                <h2 className="text-[10px] max-[768px]:text-[8px] max-[768px]:font-bold">
                  {exp.positionTitle || "Human Resource Manager"}
                </h2>
                <h3 className=" text-[8px] mb-1 font-semibold max-[768px]:text-[7px]">
                ...
                <p className="list-disc list-inside indent-3 font-light text-[10px] break-words mb-1 max-[768px]:text-[8px]">
                  {exp.workSummary ||
            ...
            <div className="w-[100%]">
              <h2 className="text-[10px] max-[768px]:text-[7px]">Human Resource Manager</h2>
              <h3 className=" text-[10px] mb-1 font-semibold max-[768px]:text-[7px]">
                Zoho, Chennai, Tamilnadu | Date</h3>
              <p className="list-disc list-inside indent-3 font-normal text-[12px] break-words mb-1 max-[768px]:text-[8px]">
        ...
        <div className="w-[90%] flex m-auto gap-4">
            ...
            {userInfo?.education?.length > 0 ? (
              userInfo?.education.map((edu, index) => (
                <div key={index}>
                  ...
                  <h3 className="font-light text-[9px] max-[768px]:text-[7px] max-[768px]:font-bold">
                    {edu.schoolName && edu.schoolLocation
                      ? `${edu.schoolName}, ${edu.schoolLocation}`
                      : "School name and location"}
                  </h3>
                  <p className="indent-3 text-[10px] mb-1 max-[768px]:text-[8px]">
                    {edu.percentage
              ...
              <div>
                <h2 className="text-[12px] max-[768px]:text-[10px]">Degree, Field of study and date</h2>
                <h3 className="font-light text-[9px] mb-1 max-[768px]:text-[8px]">
                  School name and location
                </h3>
                <p className="indent-3 text-[10px] max-[768px]:text-[8px]">Percentage - 90%</p>
              </div>
            )}
          </div>
          <div className="w-[100%] max-[768px]:w-[60%]">
            <h1 className="text-[14px] border-b-2 font-semibold border-[#1b6b5f] mb-1 text-[#1b6b5f] max-[768px]:text-[12px]">
              Achievements
            </h1>
            {userInfo?.achievements?.length > 0 ? (
              userInfo?.achievements.map((achievement, index) => (
                <div key={index}>
                  ...
                  <h3 className="font-light text-[9px] mb-1 max-[768px]:text-[7px]">
              ...
              <div>
                <h2 className="text-[10px] max-[768px]:text-[8px]">Course Name</h2>
                <h3 className="font-semibold text-[10px] mb-1 max-[768px]:text-[8px]">Academy name</h3>
        ...
        {/* project */}
        <div className="w-[90%] m-auto pt-1 mb-1 break-words">
          <h1 className="text-[14px] border-b-2 border-[#1b6b5f] font-semibold mb-1 text-[#1b6b5f] max-[768px]:text-[12px]">
            Projects
          </h1>
          {userInfo?.projects?.length > 0 ? (
            userInfo?.projects.map((project, index) => (
              <div key={index}>
                ...
                <p className="text-[10px] indent-4 max-[768px]:text-[8px]">
        ...
        <div className="w-[90%] flex m-auto gap-6 mb-1 ">
          <div className="w-[90%] font-semibold ">
            <h1 className="text-[14px] border-b-2 border-[#1b6b5f] mb-1 text-[#1b6b5f] max-[768px]:text-[12px]">
              Skills
            </h1>
            <ul className="list-disc list-inside pl-6 font-light text-[8px]">
