    ...
    <>
      <div className="h-[100vh] w-screen bg-[#000000bf] relative flex justify-center items-center text-white px-4 max-[426px]:h-auto max-[426px]:px-0">
        <div class="w-[600px] h-[100vh] text-black bg-white download max-[426px]:w-[100%]">
          {/* header */}
          <div className="bg-[#b2436f] text-white">
            <div className="w-[90%] pt-2 m-auto flex justify-between">
              <div>
                <h1 className="text-[20px] font-bold max-[768px]:text-[15px]">
                ...
                <h2 className="text-[14px] max-[768px]:text-[12px]">
            ...
            {/* Objective */}
            <div className="w-[90%] m-auto pt-1 pb-1 text-[12px] break-words">
          ...
          <div className="w-[90%] m-auto pt-1 font-semibold">
            <h1 className="text-[14px] border-b-2 border-[#b2436f] mb-1 text-[#b2436f] max-[768px]:text-[12px]">
              Experience
            </h1>
            {userInfo?.experience?.length > 0 ? (
              ...
              <div className="w-[100%]">
                <h2 className="text-[10px] max-[768px]:text-[7px]">
                  Human Resource Manager
                </h2>
                <h3 className=" text-[10px] mb-1 font-semibold max-[768px]:text-[7px]">
                  Zoho, Chennai, Tamilnadu | Date
                </h3>
          ...
          <div className="w-[90%] flex m-auto gap-4">
            <div className="w-[100%] font-semibold">
              ...
              {userInfo?.education?.length > 0 ? (
                ...
                <div>
                  ...
                  <p className="indent-3 text-[10px] max-[768px]:text-[8px]">
                    Percentage - 90%
                  </p>
                </div>
              )}
            ...
            <div className="w-[100%] max-[768px]:w-[60%]">
              <h1 className="text-[14px] border-b-2 font-semibold border-[#b2436f] mb-1 text-[#b2436f] max-[768px]:text-[12px]">
                Achievements
              </h1>
          ...
          <div className="w-[90%] m-auto pt-1 mb-1 break-words">
            <h1 className="text-[14px] border-b-2 border-[#b2436f] font-semibold mb-1 text-[#b2436f] max-[768px]:text-[12px]">
              Projects
            </h1>
...
export default PreviewTemplate4;
