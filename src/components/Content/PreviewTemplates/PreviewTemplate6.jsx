        ...
        <div class="w-[600px] h-[100vh] text-black bg-white download max-[426px]:w-[100%]">
          <div className="w-[100%] bg-[#0d183a] text-white">
            <div className="w-[100%] flex justify-center items-center">
              ...
              <div className="w-[30%] m-auto pt-6 max-[768px]:pt-3">
            ...
            <div className="w-[90%] pt-1 text-[10px] break-words max-[768px]:text-[8px] max-[321px]:text-[7px]">
              <p className="indent-4 pl-6 pb-2">
          ...
          <div className="w-[100%] flex border-t-2 border-[#0d183a]">
            <div className="h-auto w-[70%] border-r-2 border-[#0d183a] max-[768px]:pt-0">
              <div className="w-[100%] pt-1 font-bold border-b-2 border-[#0d183a]">
                <h1 className="text-[15px] mb-1 pl-6 max-[768px]:text-[12px] max-[321px]:text-[11px]">
                  Experience
                </h1>
                {userInfo.experience?.length > 0 ? (
                  ...
                  <div className="pl-6">
                    ...
                    <h3 className="font-light text-[8px] mb-1 max-[768px]:text-[6px]">
                      Date
                    </h3>
              ...
              <div className="w-[100%] mt-1 border-b-2 border-[#0d183a]">
                <h1 className="text-[15px] font-bold mb-1 pl-6 max-[768px]:text-[12px]">
                  Education
                </h1>
                {userInfo.education?.length > 0 ? (
                  ...
                  <div className="pl-6">
                    ...
                    <p className="indent-3 text-[8px] max-[768px]:text-[7px]">
                      Percentage - 90%
                    </p>
                  </div>
                )}
              </div>
              <div className="w-[100%] py-2 break-words max-[426px]:py-0">
                <h1 className="text-[15px] pl-6 font-bold mb-1 max-[768px]:text-[12px]">
                  Projects
                </h1>
            ...
            <div className="h-auto w-[40%]">
              <div className="w-[100%] pt-1 font-semibold border-b-2 border-[#0d183a]">
                <h1 className="text-[15px] mb-3 pl-6 max-[768px]:text-[12px] max-[768px]:mb-1 max-[426px]:pl-2">
                  Skills
                </h1>
                <ul className="list-disc list-inside pl-10 font-light text-[12px] max-[426px]:pl-4 max-[768px]:text-[10px]">
              ...
              <div className="w-[100%] pt-1 border-b-2 border-[#0d183a]">
                <h1 className="text-[15px] font-semibold pl-6 mb-1 max-[768px]:text-[12px] max-[768px]:mb-1 max-[426px]:pl-2">
                  Achievements
                </h1>
                {userInfo.achievements?.length > 0 ? (
                  userInfo.achievements.map((achievement, index) => (
                    <div key={index} className="pl-6 max-[426px]:pl-2">
                      <h2 className="text-[12px] font-bold max-[768px]:text-[10px]">
                        {achievement.courseName || "Course Name"}
                      </h2>
                      <h3 className="font-bold text-[10px] mb-1 max-[768px]:text-[8px] max-[768px]:mb-0 ">
                  ...
                  <div className="pl-6 max-[426px]:pl-2">
                    <h2 className="text-[12px] max-[768px]:text-[10px]">
                      Course Name
                    </h2>
              ...
              <div className="w-[100%] pt-1 font-semibold border-b-2 border-[#0d183a]">
                <h1 className="text-[15px] pl-6 mb-1 max-[426px]:pl-2 max-[768px]:text-[12px] max-[768px]:mb-1">
                  Hobbies
                </h1>
                <ul className="list-disc list-inside pl-10 font-light text-[12px] max-[426px]:pl-4 max-[768px]:text-[10px]">
              ...
              <div className="w-[100%] pt-1 font-semibold">
                <h1 className="text-[15px] pl-6 mb-1 max-[426px]:pl-2 max-[768px]:text-[12px] max-[768px]:mb-1">
                  Languages
                </h1>
                <ul className="list-disc list-inside pl-10 font-light text-[12px] max-[426px]:pl-4 max-[768px]:text-[10px]">
...
export default PreviewTemplate6;
