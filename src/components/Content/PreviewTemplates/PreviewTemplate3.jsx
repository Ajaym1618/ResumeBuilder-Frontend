...
const PreviewTemplate3 = () => {
  ...
  return (
    <>
        ...
        <div class="w-[600px] h-[100vh] flex gap-5 text-black bg-white download max-[426px]:w-[100%]">
          <div className="h-auto w-[60%] pt-5 max-[768px]:pt-3">
            <div className="w-[90%] m-auto pt-2">
              <h1 className="text-[20px] font-bold text-[#2c5977] max-[768px]:text-[15px] max-[321px]:text-[14px]">
              ...
              <h2 className="text-[15px] text-[#2c5977] max-[768px]:text-[12px] max-[321px]:text-[11px]">
            ...
            <div className="w-[90%] m-auto pt-1 text-[10px] break-words max-[768px]:text-[8px] max-[321px]:text-[7px]">
              <h1 className="text-[15px] border-b-2 font-bold border-[#2c5977] mb-1 text-[#2c5977] max-[768px]:text-[12px] max-[321px]:text-[11px]">
                Objective
              </h1>
            ...
            <div className="w-[90%] m-auto pt-1 font-bold">
              <h1 className="text-[15px] border-b-2 border-[#2c5977] mb-1 text-[#2c5977] max-[768px]:text-[12px] max-[321px]:text-[11px]">
                Experience
              </h1>
            ...
            <div className="w-[90%] m-auto mt-1">
              <h1 className="text-[15px] border-b-2 font-bold border-[#2c5977] mb-1 text-[#2c5977] max-[768px]:text-[12px]">
                Education
              </h1>
            ...
            <div className="w-[90%] m-auto py-1 break-words max-[426px]:py-0">
              <h1 className="text-[15px] border-b-2 border-[#2c5977] font-bold mb-1 text-[#2c5977]  max-[768px]:text-[12px]">
                Projects
              </h1>
          ...
          <div className="h-[100vh] w-[40%] bg-[#2c5977] text-white">
      ...
      <button
        className="w-[100px] block z-20 absolute top-[90%] right-[34%] text-white bg-[#135c4d] py-2 shadow-slate-500 shadow-lg text-[16px] rounded-md active:scale-95 duration-150  max-[426px]:text-[12px] max-[768px]:right-[23%] max-[426px]:right-[10%]"
        onClick={download}
      >
        Download
      </button>
...
export default PreviewTemplate3;
