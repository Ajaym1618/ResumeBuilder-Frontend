        ...
        <div className="relative w-full px-8 h-[70vh] flex items-center justify-center max-[768px]:h-[60vh] max-[426px]:px-0">
          ...
          >
            {[...templates, ...templates.slice(0, 3)].map((template, i) => (
              <div
                key={i}
                className="w-[25%] h-full flex-shrink-0 relative rounded-md hover:scale-95 transition-transform duration-150 max-[426px]:w-[50%] max-[768px]:w-[35%] max-[426px]:w-[100px]"
