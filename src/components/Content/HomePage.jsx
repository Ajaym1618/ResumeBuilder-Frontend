...
const HomePage = () => {
  return (
    <>
      <Header />
      <div className="w-screen h-[85vh] bg-[#100f0f] flex text-white max-[375px]:h-[85vh] max-[426px]:block">
        ...
        <div className="w-[50%] h-full flex justify-center items-start flex-col max-[768px]:w-full max-[426px]:w-[100%] max-[426px]:items-center max-[426px]:justify-start max-[426px]:text-center max-[426px]:pt-40">
