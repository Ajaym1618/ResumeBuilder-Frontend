...
const HomePage = () => {
  return (
    <>
      <Header />
      <div className="w-screen h-[85vh] bg-[#100f0f] flex text-white max-[426px]:block max-[426px]:h-[80vh]">
        <div className="w-[50%] h-[50%] flex items-center justify-center max-[768px]:w-full max-[376px]:items-start max-[375px]:mb-40px">
          <img
            src={HI}
            alt="Home-Image"
        ...
        <div className="w-[50%] h-[50%] flex justify-center items-start flex-col max-[768px]:w-full max-[426px]:w-[100%] max-[426px]:items-center max-[426px]:justify-start max-[426px]:text-center max-[426px]:pt-30">
