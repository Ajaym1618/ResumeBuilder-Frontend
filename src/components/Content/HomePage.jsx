  ...
  return (
    <>
      ...
      <div className="w-screen h-[85vh] bg-[#100f0f] flex text-white max-[426px]:flex max-[426px]:flex-col-reverse">
        ...
        <div className="w-[50%] mt-20 max-[768px]:w-full max-[768px]:mt-[120px] max-[426px]:w-[100%] max-[426px]:flex max-[426px]:flex-col max-[426px]:items-center max-[426px]:justify-start max-[426px]:text-center">
