  ...
  return (
    <>
      ...
      <div className="w-screen h-[85vh] bg-[#100f0f] flex text-white max-[426px]:flex max-[426px]:flex-col-reverse">
        ...
        <div className="w-[50%] mt-20 max-[768px]:w-full max-[768px]:mt-[120px] max-[426px]:pt-5 max-[426px]:mt-0 max-[426px]:w-[100%] max-[426px]:flex max-[426px]:flex-col max-[426px]:items-center max-[426px]:justify-start max-[426px]:text-center">
          <h1 className="text-[48px] font-medium leading-[60px] w-[70%] mb-[40px] max-[768px]:text-[32px] max-[768px]:mb-[20px] max-[768px]:leading-[35px] max-[426px]:w-[100%] max-[426px]:text-[24px]">
