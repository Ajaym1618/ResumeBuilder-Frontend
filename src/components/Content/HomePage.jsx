  ...
  return (
    <>
      ...
      <div className="w-screen h-[85vh] bg-[#100f0f] flex text-white max-[375px]:h-[85vh] max-[426px]:flex max-[426px]:flex-col-reverse">
        <div className="w-[50%] flex items-center justify-center max-[768px]:w-full max-[376px]:items-start max-[376px]:h-[50%]">
          <img
            src={HI}
            alt="Home-Image"
        ...
        <div className="w-[50%] h-full flex justify-center items-start flex-col max-[768px]:w-full max-[426px]:w-[100%] max-[426px]:items-center max-[426px]:justify-start max-[426px]:text-center max-[426px]:pt-20 max-[376px]:h-[50%]">
